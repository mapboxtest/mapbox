...
function App() {
  ...
  if (answerValue <= 5) {
    ...
    recommendations = 'Могло быть и хуже, но тебе тоже не хватает треша и ярких впечатлений! Пришла пора ослабить над собой контроль, и сделать то, на что давно не мог решиться! Приди на нашу вечеринку в костюме символа 20120 года, так ты точно окажешься в центре внимания и запомнишь этот день надолго!    ';
    finalWords = 'Адекватный';
  } else if (answerValue <= 15) {
    recommendations = 'Ты не так прост, как кажется! Самое время выпустить всех своих внутренних демонов, покажи своим коллегам, какой ты есть на самом деле. Иногда полезно идти на риск и открывать в себе неизведанное. Приходи на мероприятие на без нижнего белья, никто, конечно не узнает, но ты точно запомнишь это надолго!';
